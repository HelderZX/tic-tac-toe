...
function checkWin(){
    ...
    function paint(one, two, three){
        if(playing){
            ...
            if(player == 1) showResult(document.getElementById('player1').querySelectorAll('div')[1].getAttribute('name')+" venceu");
            else if(player == 2) showResult(document.getElementById('player2').querySelectorAll('div')[1].getAttribute('name')+" venceu");
            playing = false;
            win = true;
        }
    }
